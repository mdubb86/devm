...
func socketpairConns(t *testing.T) (guest net.Conn, softnetConn net.Conn) {
	t.Helper()
...
func startNetwork(t *testing.T, guest, softnetConn net.Conn) {
	t.Helper()
	n, err := newNetwork()
	if err != nil {
	...
	t.Cleanup(cancel)
	go func() { _ = n.sw.Accept(ctx, softnetConn, "vfkit") }()
}
...
func TestARPRoundTrip(t *testing.T) {
	...
	startNetwork(t, guest, softnetConn)
