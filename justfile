...
e2e-bootstrap: (_build-helper-embed "e2e") (_build-setsid-shim-embed) (_build-pop-embed) (_build-run-embed) (_build-tart-mutagen-ssh-embed) mac-build-e2e (_build "e2e")
    @sudo -v
