...
**Pinned by:**
  ...
  - `e2e/test_sbx_interop_02_publish_triggered.py` — a probe
...
`e2e/test_sbx_interop_01_publish_baseline.py`) does literally
...
- `e2e/test_sbx_interop_01_publish_baseline.py` — Go binary works
