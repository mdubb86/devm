...
**Pinned by:**
  ...
  - `e2e/test_sbx_interop_04_anchor_spawner_ticker.py` — a probe
...
`e2e/test_sbx_interop_03_anchor_publish_baseline.py`) does literally
...
- `e2e/test_sbx_interop_03_anchor_publish_baseline.py` — Go binary works
