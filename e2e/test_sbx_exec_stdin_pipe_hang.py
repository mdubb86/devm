"""`sbx exec NAME ...` with piped stdin hangs.
...
This test runs the broken pattern with a short timeout. If it
completes within the timeout, sbx fixed the hang — and we can drop
