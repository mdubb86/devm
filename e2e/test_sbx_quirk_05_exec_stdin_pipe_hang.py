"""sbx-quirk 05: pins the upstream `sbx exec` stdin-pipe hang.
...
This guard test runs the broken pattern with a short timeout. If
it completes within the timeout, sbx fixed the hang — and we can
drop the base64 workaround.
"""
